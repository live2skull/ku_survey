function teaser_old() {
    ...
    function forever() {
        ...
        console.log('  _       ____ __      __ ______  _   __     __ ______');
        console.log(' | |     / __ \\\\ \\    / /|  ____|| |  \\ \\   / /|___  /');
        console.log(' | |    | |  | |\\ \\  / / | |__   | |   \\ \\_/ /    / / ');
        console.log(' | |    | |  | | \\ \\/ /  |  __|  | |    \\   /    / /  ');
        console.log(' | |____| |__| |  \\  /   | |____ | |____ | |    / /__ ');
        console.log(' |______|\\____/    \\/    |______||______||_|   /_____|');
        console.log("");
        console.log("   >> LOVELYZ Comeback in 2017. 02. 26 22:00 !!! << ");

        setTimeout(forever, 50);
    }

    $('#ResponsiveNav').html('');
    $('#navbar-brand-span').html('<img id="navbar-brand" src="/public/images/logo-hidden.png" alt="brand">&nbsp;&nbsp' + message);
